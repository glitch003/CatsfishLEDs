...
void copy_led_array(){
  for(int i = 0; i < NUM_LEDS; i++ ) {
    ledsX[i] = neopixel.getPixelColor(i);
  }  
}
...
void one_color_all(int cred, int cgrn, int cblu) { //-SET ALL LEDS TO ONE COLOR
    for(int i = 0 ; i < NUM_LEDS; i++ ) {
      neopixel.setPixelColor(i, cred, cgrn, cblu);
      neopixel.show();       
      delay(1);
    }  
}
...
void rainbow_fade(int idelay) { //-FADE ALL LEDS THROUGH HSV RAINBOW
    ...
    for(int idex = 0 ; idex < NUM_LEDS; idex++ ) {
      neopixel.setPixelColor(idex,thisColor[0],thisColor[1],thisColor[2]); 
    }
    neopixel.show();    
    delay(idelay);
}
...
void rainbow_loop(int istep, int idelay) { //-LOOP HSV RAINBOW
  ...
  neopixel.setPixelColor(idex, icolor[0], icolor[1], icolor[2]);
  neopixel.show();
  delay(idelay);
}
...
void color_bounce(int idelay) { //-BOUNCE COLOR (SINGLE LED)
  ...
  for(int i = 0; i < NUM_LEDS; i++ ) {
    if (i == idex) {neopixel.setPixelColor(i, 255, 0, 0);}
    else {neopixel.setPixelColor(i, 0, 0, 0);}
  }
  neopixel.show();
  delay(idelay);
}
...
void police_lightsONE(int idelay) { //-POLICE LIGHTS (TWO COLOR SINGLE LED)
  ...
  for(int i = 0; i < NUM_LEDS; i++ ) {
    if (i == idexR) {neopixel.setPixelColor(i, 255, 0, 0);}
    else if (i == idexB) {neopixel.setPixelColor(i, 0, 0, 255);}    
    else {neopixel.setPixelColor(i, 0, 0, 0);}
  }
  neopixel.show();  
  delay(idelay);
...
void police_lightsALL(int idelay) { //-POLICE LIGHTS (TWO COLOR SOLID)
  ...
  int idexR = idex;
  int idexB = antipodal_index(idexR);
  neopixel.setPixelColor(idexR, 255, 0, 0);
  neopixel.setPixelColor(idexB, 0, 0, 255);
  neopixel.show();  
  delay(idelay);
}
...
void color_bounceFADE(int idelay) { //-BOUNCE COLOR (SIMPLE MULTI-LED FADE)
  ...
  for(int i = 0; i < NUM_LEDS; i++ ) {
    if (i == idex) {neopixel.setPixelColor(i, 255, 0, 0);}
    else if (i == iL1) {neopixel.setPixelColor(i, 100, 0, 0);}
    else if (i == iL2) {neopixel.setPixelColor(i, 50, 0, 0);}
    else if (i == iL3) {neopixel.setPixelColor(i, 10, 0, 0);}        
    else if (i == iR1) {neopixel.setPixelColor(i, 100, 0, 0);}
    else if (i == iR2) {neopixel.setPixelColor(i, 50, 0, 0);}
    else if (i == iR3) {neopixel.setPixelColor(i, 10, 0, 0);}    
    else {neopixel.setPixelColor(i, 0, 0, 0);}
  }
...
void flicker(int thishue, int thissat) {
  ...
  if (random_bool < 10) {
    ...
    for(int i = 0 ; i < NUM_LEDS; i++ ) {
      neopixel.setPixelColor(i, thisColor[0], thisColor[1], thisColor[2]);
    }
...
void pulse_one_color_all(int ahue, int idelay) { //-PULSE BRIGHTNESS ON ALL LEDS TO ONE COLOR 
  ...
  HSVtoRGB(ahue, 255, ibright, acolor);
    ...
    for(int i = 0 ; i < NUM_LEDS; i++ ) {
      neopixel.setPixelColor(i, acolor[0], acolor[1], acolor[2]);
    }
    neopixel.show();    
    delay(idelay);
}
...
void random_red() { //QUICK 'N DIRTY RANDOMIZE TO GET CELL AUTOMATA STARTED  
  ...
  for(int i = 0; i < NUM_LEDS; i++ ) {
    ...
    if (temprand > 50) {neopixel.setPixelColor(i, 255, 0, 0);}
    if (temprand <= 50) {neopixel.setPixelColor(i, 0, 0, 0);}
  }
  neopixel.show();  
}
...
//  leds[0].g = acolor[1];
//  leds[0].b = acolor[2];
  neopixel.setPixelColor(0, acolor[0], acolor[1], acolor[2]);
...
//    leds[i].b = ledsX[iCCW][2];
    neopixel.setPixelColor(i, ledsX[iCCW]);
  }
...
void white_temps() {
  ...
  for (int i = 0; i < NUM_LEDS; i++ ) {
    if (i >= 0 && i < N9) {neopixel.setPixelColor(i, 255, 147, 41);} //-CANDLE - 1900
    if (i >= N9 && i < N9*2) {neopixel.setPixelColor(i, 255, 197, 143);} //-40W TUNG - 2600
    if (i >= N9*2 && i < N9*3) {neopixel.setPixelColor(i, 255, 214, 170);} //-100W TUNG - 2850
    if (i >= N9*3 && i < N9*4) {neopixel.setPixelColor(i, 255, 241, 224);} //-HALOGEN - 3200
    if (i >= N9*4 && i < N9*5) {neopixel.setPixelColor(i, 255, 250, 244);} //-CARBON ARC - 5200
    if (i >= N9*5 && i < N9*6) {neopixel.setPixelColor(i, 255, 255, 251);} //-HIGH NOON SUN - 5400
    if (i >= N9*6 && i < N9*7) {neopixel.setPixelColor(i, 255, 255, 255);} //-DIRECT SUN - 6000
    if (i >= N9*7 && i < N9*8) {neopixel.setPixelColor(i, 201, 226, 255);} //-OVERCAST SKY - 7000
    if (i >= N9*8 && i < NUM_LEDS) {neopixel.setPixelColor(i, 64, 156, 255);} //-CLEAR BLUE SKY - 20000  
  }
  neopixel.show();  
  delay(100);
}
...
//      neopixel.setPixelColor(i, bcolor[0], bcolor[1], bcolor[2]);
      neopixel.setPixelColor(i, 0, 0, 0);
    }
  }
...
//    leds[i].b = ledsX[iCW][2];   
    neopixel.setPixelColor(i, ledsX[iCW]);
...
void pop_horizontal(int ahue, int idelay) {  //-POP FROM LEFT TO RIGHT UP THE RING
  ...
  for(int i = 0; i < NUM_LEDS; i++ ) {
    if (i == ix) {neopixel.setPixelColor(i, acolor[0], acolor[1], acolor[2]);}
    else {neopixel.setPixelColor(i, 0, 0, 0);}
  }
...
//    leds[x].r = acolor[0]; leds[x].g = acolor[1]; leds[x].b = acolor[2];
    neopixel.setPixelColor(x, acolor[0], acolor[1], acolor[2]);
...
//    leds[ih].r = acolor[0]; leds[ih].g = acolor[1]; leds[ih].b = acolor[2];
    neopixel.setPixelColor(ih, acolor[0], acolor[1], acolor[2]);

    
//    leds[TOP_INDEX].r = 255; leds[TOP_INDEX].g = 255; leds[TOP_INDEX].b = 255;
        neopixel.setPixelColor(TOP_INDEX, 255, 255, 255);
...
//    leds[j0].r = acolor[0]; leds[j0].g = acolor[1]; leds[j0].b = acolor[2];
    neopixel.setPixelColor(j0, acolor[0], acolor[1], acolor[2]);

//    leds[j1].r = acolor[0]; leds[j1].g = acolor[1]; leds[j1].b = acolor[2];
    neopixel.setPixelColor(j1, acolor[0], acolor[1], acolor[2]);
//    leds[j2].r = acolor[0]; leds[j2].g = acolor[1]; leds[j2].b = acolor[2];    
    neopixel.setPixelColor(j2, acolor[0], acolor[1], acolor[2]);
...
void swiss_cross(int idelay) { //-swiss cross
  ...
  for(int i = 0; i < 4; i++) {
    for(int j = -(count/2); j < (count/2); j++) {
      ...
      neopixel.setPixelColor(pixel, 255, 255, 255);
    }
  }    
    neopixel.show();    
    delay(idelay);    
...
void germany(int idelay) { //-german flag
  ...
  int split = 12;
  for(int i = 0; i < NUM_LEDS; i++) {
    if ( i < (NUM_LEDS/split)) { neopixel.setPixelColor(i, 255, 0, 0);}
    else if ( i < (NUM_LEDS/split*(split/2-1))) { neopixel.setPixelColor(i, 0, 0, 0);}
    else if ( i < (NUM_LEDS/split*(split/2+1))) { neopixel.setPixelColor(i, 255, 0, 0);}
    else if ( i < (NUM_LEDS/split*(split-1))) { neopixel.setPixelColor(i, 255, 204, 0);}
    else {neopixel.setPixelColor(i, 255, 0, 0);}
  }    
    neopixel.show();    
    delay(idelay);    
}
...
void fade_vertical(int ahue, int idelay) { //-FADE 'UP' THE LOOP
  ...
  neopixel.setPixelColor(idexA, acolor[0], acolor[1], acolor[2]);  
  neopixel.setPixelColor(idexB, acolor[0], acolor[1], acolor[2]);  
...
//      leds[s].r = 0; leds[s].g = 0; leds[s].b = 0;}
      neopixel.setPixelColor(s, 0, 0, 0);}

  if (lcount == 2 || lcount == 4) {
      one_color_allNOSHOW(255,255,0);
//      leds[s-1].r = 0; leds[s-1].g = 0; leds[s-1].b = 0; 
      neopixel.setPixelColor(s-1, 0, 0, 0);
...
//      leds[s-2].r = 0; leds[s-2].g = 0; leds[s-2].b = 0;
      neopixel.setPixelColor(s-2, 0, 0, 0);  
//      leds[s-1].r = 0; leds[s-1].g = 0; leds[s-1].b = 0;  
      neopixel.setPixelColor(s-1, 0, 0, 0);
//      leds[s].r = 0; leds[s].g = 0; leds[s].b = 0;
      neopixel.setPixelColor(s, 0, 0, 0);
...
//  for (int i=0; i < leds.numPixels(); i++) {
    ...
    int current = neopixel.getPixelColor(0);
    for (int i=0; i < NUM_LEDS; i++) {
    neopixel.setPixelColor(i, color);
    neopixel.show();
    ...
    neopixel.show();
    neopixel.setPixelColor(i, current);
    neopixel.show();
    delay(wait);
  }
}
...
{
    int current = neopixel.getPixelColor(NUM_LEDS-1);
...
//  for (int i=0; i < leds.numPixels(); i++) {
    ...
    int current = neopixel.getPixelColor(start);
...
//  for (int i=0; i < leds.numPixels(); i++) {
    ...
    neopixel.setPixelColor(i+1, color);
    neopixel.setPixelColor(i+2, color);
    neopixel.setPixelColor(NUM_LEDS-i, color);
    neopixel.setPixelColor(NUM_LEDS-1-i, color);
    neopixel.setPixelColor(NUM_LEDS-2-i, color);    
    neopixel.show();
    neopixel.setPixelColor(i, 0x000000);
    neopixel.setPixelColor(NUM_LEDS-i, 0x000000);
    neopixel.show();
    delay(wait);
  }
}
...
//  for (int i=0; i < leds.numPixels(); i++) {
    ...
    neopixel.setPixelColor(i+4, color);
    neopixel.setPixelColor(NUM_LEDS-1-i, color);
    neopixel.setPixelColor(NUM_LEDS-3-i, color);
    neopixel.setPixelColor(NUM_LEDS-5-i, color);    
    neopixel.show();
    neopixel.setPixelColor(i, current);
    neopixel.setPixelColor(NUM_LEDS-1-i, current);
    neopixel.show();
    delay(wait);
  }
}
...
void randomPixelColor(int wait)
{
  ...
  int current = neopixel.getPixelColor(pixel);
  neopixel.setPixelColor(pixel, rr, rg, rb);
  neopixel.show();
  delay(wait);
  neopixel.setPixelColor(pixel, current);
  neopixel.show();
  delay(wait);
}
